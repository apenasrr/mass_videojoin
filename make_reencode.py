...
def create_backup_columns(df):
    ...
    list_backup_columns = ('file_path_folder', 'file_name', 'file_size',
                           'video_resolution_height', 'video_resolution_width')
...
def reencode_video(dict_, path_folder_encoded):
    ...
    try:
        ...
        path_file_origin = os.path.join(dict_['file_path_folder_origin'],
...
def update_file_report(path_file_report, dict_video_data, path_folder_encoded):
    ...
    # update df
    df.loc[index_video, 'file_path_folder'] = \
